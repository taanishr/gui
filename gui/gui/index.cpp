...
(
    div(NewArch::Size::px(280), NewArch::Size::px(360), simd_float4{1.0,1.0,1.0,1.0})
    ...
    (
        image("/Users/treja/Downloads/jingbo.jpg", NewArch::Size::px(80), NewArch::Size::px(80))
        ...
        div(NewArch::Size::percent(0.8), NewArch::Size::px(40), simd_float4{0.4,0.3,1.0,1.0})
    ...
    //         .alignItems(NewArch::AlignItems::FlexStart)
    //         .flexDirection(NewArch::FlexDirection::Col)
    //     (
