...
auto index() -> Element
{
    ...
    return div().h(100.0).color(RGB{0,0,128,0.5}).w(100.0).y(100.0).x(0)(
                div().color(RGB{128,0,0,0.5}).w(100).h(100).y(300.0)
            );
//        div().h(100.0).w(100.0).cornerRadius(50.0).x(0).y(100.0).color(RGB{0,0,128,0.5}).on<EventType::Click>(onClick).flex()
//            (
//                text("").fontSize(24.0).x(10.0).y(25.0).on<EventType::KeyboardDown>(onInput),
//                div().h(100.0).w(100.0).y(128.0).color(RGB{128,0,0,0.5})(
//                     div().h(50.0).w(50.0).y(25.0).x(128.0).cornerRadius(25).color(RGB{255,255,255,1}).borderColor(RGB{125,0,0,0.5}).borderWidth(2)
//                ),
