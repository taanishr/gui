...
#ifndef APPKIT_EXTENSIONS_SWIFT_H
#define APPKIT_EXTENSIONS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppKit_Extensions",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("AppKit_Extensions", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
SWIFT_INLINE_THUNK void setWindowTransparent(void * _Nonnull windowPtr) noexcept SWIFT_SYMBOL("s:17AppKit_Extensions20setWindowTransparent9windowPtrySv_tF") {
  AppKit_Extensions::_impl::$s17AppKit_Extensions20setWindowTransparent9windowPtrySv_tF(windowPtr);
}
