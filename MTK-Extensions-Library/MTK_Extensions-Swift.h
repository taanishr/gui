...
#ifndef MTK_EXTENSIONS_SWIFT_H
#define MTK_EXTENSIONS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MTK_Extensions",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("MTK_Extensions", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace MTK_Extensions SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("MTK_Extensions") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN void * _Nonnull $s14MTK_Extensions22createMTKTextureLoader9devicePtrS2v_tF(void * _Nonnull devicePtr) SWIFT_NOEXCEPT SWIFT_CALL; // createMTKTextureLoader(devicePtr:)
SWIFT_EXTERN void * _Nullable $s14MTK_Extensions13createTexture9loaderPtr8filePathSvSgSv_SPys4Int8VGtF(void * _Nonnull loaderPtr, char const * _Nonnull filePath) SWIFT_NOEXCEPT SWIFT_CALL; // createTexture(loaderPtr:filePath:)
SWIFT_EXTERN void $s14MTK_Extensions23releaseMTKTextureLoader9loaderPtrySv_tF(void * _Nonnull loaderPtr) SWIFT_NOEXCEPT SWIFT_CALL; // releaseMTKTextureLoader(loaderPtr:)
...
SWIFT_INLINE_THUNK void * _Nonnull createMTKTextureLoader(void * _Nonnull devicePtr) noexcept SWIFT_SYMBOL("s:14MTK_Extensions22createMTKTextureLoader9devicePtrS2v_tF") SWIFT_WARN_UNUSED_RESULT {
  return MTK_Extensions::_impl::$s14MTK_Extensions22createMTKTextureLoader9devicePtrS2v_tF(devicePtr);
}

SWIFT_INLINE_THUNK void * _Nullable createTexture(void * _Nonnull loaderPtr, char const * _Nonnull filePath) noexcept SWIFT_SYMBOL("s:14MTK_Extensions13createTexture9loaderPtr8filePathSvSgSv_SPys4Int8VGtF") SWIFT_WARN_UNUSED_RESULT {
  return MTK_Extensions::_impl::$s14MTK_Extensions13createTexture9loaderPtr8filePathSvSgSv_SPys4Int8VGtF(loaderPtr, filePath);
}

SWIFT_INLINE_THUNK void releaseMTKTextureLoader(void * _Nonnull loaderPtr) noexcept SWIFT_SYMBOL("s:14MTK_Extensions23releaseMTKTextureLoader9loaderPtrySv_tF") {
  MTK_Extensions::_impl::$s14MTK_Extensions23releaseMTKTextureLoader9loaderPtrySv_tF(loaderPtr);
}
